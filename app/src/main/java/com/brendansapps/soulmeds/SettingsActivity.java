...
/**
 * created 05/22/18 by bt
 *
 * Settings activity based off Android template settings activity
 *
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    // helper fn, returns true if on extra-large screen (ie. 10" tablet)
    ...
    // Bind preference summaries & values, makes summary react to value, auto-updated when this method called @see #sBindPreferenceSummaryToValueListener
